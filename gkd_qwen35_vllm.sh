...
TEACHER_MAX_MODEL_LEN=4608         # slightly above max_length to be safe
...
start_teacher() {
    ...
    echo "ERROR: Teacher server did not become ready in 120s"
...
#   bs=2, grad_accum=42 → 2×42×4096×6 ≈ 2.06M tokens/step
# ══════════════════════════════════════════════════════════════════════════════
