...
STUDENT_MODEL=/home/r00914194/PruneMe/qwen35_layerprune_161127

PHASE1_OUTPUT=output/gkd_qwen35_24layers
PHASE2_OUTPUT=output/gkd_qwen35_24layers
PHASE3_OUTPUT=output/gkd_qwen35_24layers
PHASE4_OUTPUT=output/gkd_qwen35_24layers
...
TEACHER_MAX_MODEL_LEN=5000         # must be >= 1 + student max_length + student max_completion_length across all phases
...
STUDENT_NPROC=6
STUDENT_VLLM_MAX_MODEL_LEN=6144  #invalid now # max_length(4096) + max_completion_length(2048) for Phase 3/4
...
# --max_length 8192 \  
# --max_completion_length 1 \  #default 512
# --truncation_strategy left \
# --loss_scale all \   #remove mask of query in the ms-swift/swift/rlhf_trainers/gkd_trainer.py
