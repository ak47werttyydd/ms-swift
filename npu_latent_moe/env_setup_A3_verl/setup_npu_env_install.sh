...
# --------------------------- User-tunable paths ------------------------------
ENV_NAME="${ENV_NAME:-verl-mm}"
PY_VERSION="${PY_VERSION:-3.11}"
CANN_SETENV="${CANN_SETENV:-/home/s00525112/CANN8.5.1/cann-8.5.1/set_env.sh}"
NNAL_SETENV="${NNAL_SETENV:-/home/s00525112/CANN8.5.1/nnal/atb/set_env.sh}"

VLLM_ASCEND_DIR="${VLLM_ASCEND_DIR:-/home/s00525112/vllm-ascend}"
VERL_DIR="${VERL_DIR:-/home/s00525112/verl_from185}"
VLLM_DIR="${VLLM_DIR:-/home/s00525112/vllm}"
...
# --- ms-swift ---
[[ -d "$VERL_DIR/.git" ]] || die "ms-swift checkout not found at $VERL_DIR"
(
    cd "$VERL_DIR"
    log "Installing ms-swift from $VERL_DIR"
    pip install -e .
)
