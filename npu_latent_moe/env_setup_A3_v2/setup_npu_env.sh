...
#
# Run this ON the NPU host (NOT on macOS). It is written for Atlas 900 A3
# SuperPoD (910C / ascend910_9391, 16 NPUs/node, PCI 0xD803) running
# openEuler / linux-aarch64, with CANN 8.5.1 installed under
# /home/canada_group_account/a84400789/CANN8.5.1.
#
# Usage:
...
#   transformers      == 5.3.0               (matches GPU GKD docker; required
#                                             for Qwen3.5 LatentMoE; installed
#                                             AFTER vllm-ascend so it overrides
#                                             vllm-ascend's older pin)
#   deepspeed         == 0.18.8              (matches GPU GKD docker)
#   accelerate        == 1.13.0              (matches GPU GKD docker)
#   peft              == 0.18.1              (matches GPU GKD docker)
#   safetensors       == 0.7.0               (matches GPU GKD docker)
