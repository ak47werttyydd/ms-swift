...
MINDSPEED_REPO="${MINDSPEED_REPO:-/home/canada_group_account/a84400789/MindSpeed}"
MINDSPEED_BRANCH="${MINDSPEED_BRANCH:-core_r0.15.3}"
MCORE_BRIDGE_REPO="${MCORE_BRIDGE_REPO:-/home/canada_group_account/a84400789/mcore-bridge}"
...
# transformers==5.3.0 is required for Qwen3.5 LatentMoE.
...
# Other CUDA/Triton-only kernels excluded on NPU: flash-linear-attention,
# causal-conv1d, liger_kernel.
